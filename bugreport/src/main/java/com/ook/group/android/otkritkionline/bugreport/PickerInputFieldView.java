...
final class PickerInputFieldView extends com.ook.group.android.otkritkionline.bugreport.InputFieldView {
    ...
    public void configureWithInputField(@NonNull InputField inputField, @NonNull final ValueCoordinator valueCoordinator) {
        final com.ook.group.android.otkritkionline.bugreport.PickerInputField pickerInputField = (com.ook.group.android.otkritkionline.bugreport.PickerInputField)inputField;
    ...
    private void showPickerDialog(@NonNull final com.ook.group.android.otkritkionline.bugreport.PickerInputField pickerInputField, @NonNull final ValueCoordinator valueCoordinator) {
