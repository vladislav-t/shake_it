        ...
        if (permissionHelper == null) {
            ...
            permissionHelper.setPermissionCallback(new PermissionHelper.PermissionCallback() {
                ...
                public void onPermissionDenied() {
                    com.ook.group.android.otkritkionline.bugreport.Log.w("Buglife needs read storage permission to capture screenshots!");
                    ...
                    try {
                        ...
                        if (cursor != null && cursor.moveToFirst()) {
                            ...
                            if (matchPath(path) && matchTime(currentTime, dateAdded)) {
                                com.ook.group.android.otkritkionline.bugreport.Log.d("Got screenshot: " + path);
                                screenshotPath = path;
                            }
                        }
                    } catch (Exception e) {
                        com.ook.group.android.otkritkionline.bugreport.Log.e("Open cursor failed", e);
                    } finally {
                        if (cursor != null) {
                            cursor.close();
                        }
