...
class Annotation {
    ...
    private com.ook.group.android.otkritkionline.bugreport.PercentPoint mStartPercentPoint = new com.ook.group.android.otkritkionline.bugreport.PercentPoint(0, 0);
    private com.ook.group.android.otkritkionline.bugreport.PercentPoint mEndPercentPoint = new com.ook.group.android.otkritkionline.bugreport.PercentPoint(0, 0);
    private com.ook.group.android.otkritkionline.bugreport.AnnotationRenderer renderer;
    ...
    public static Annotation newArrowInstance() {
        ...
        annotation.renderer = new com.ook.group.android.otkritkionline.bugreport.ArrowRenderer(fillColor, strokeColor);
        return annotation;
    }
    ...
    public static Annotation newLoupeInstance(Context context) {
        ...
        annotation.renderer = new com.ook.group.android.otkritkionline.bugreport.LoupeRenderer(strokeWidth);
        return annotation;
    }

    public static Annotation newBlurInstance() {
        Annotation annotation = new Annotation(Type.BLUR);
        annotation.renderer = new com.ook.group.android.otkritkionline.bugreport.BlurRenderer();
        return annotation;
    }
    ...
    private Annotation(Annotation annotation) {
        ...
        mStartPercentPoint = new com.ook.group.android.otkritkionline.bugreport.PercentPoint(annotation.mStartPercentPoint);
        mEndPercentPoint = new com.ook.group.android.otkritkionline.bugreport.PercentPoint(annotation.mEndPercentPoint);
    }

    com.ook.group.android.otkritkionline.bugreport.PercentPoint getStartPercentPoint() {
    ...
    void setStartPercentPoint(com.ook.group.android.otkritkionline.bugreport.PercentPoint startPercentPoint) {
        mStartPercentPoint = startPercentPoint;
    }

    void setStartPercentPoint(float x, float y) {
        mStartPercentPoint = new com.ook.group.android.otkritkionline.bugreport.PercentPoint(x, y);
    }

    com.ook.group.android.otkritkionline.bugreport.PercentPoint getEndPercentPoint() {
        return mEndPercentPoint;
    }

    void setEndPercentPoint(com.ook.group.android.otkritkionline.bugreport.PercentPoint endPercentPoint) {
        mEndPercentPoint = endPercentPoint;
    }

    void setEndPercentPoint(float x, float y) {
        mEndPercentPoint = new com.ook.group.android.otkritkionline.bugreport.PercentPoint(x, y);
    }
