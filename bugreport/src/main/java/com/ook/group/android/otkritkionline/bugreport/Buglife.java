...
public final class Buglife {
    @Nullable private static com.ook.group.android.otkritkionline.bugreport.Client mClient = null;
    ...
    public static void initWithApiKey(@NonNull Application application, @NonNull String apiKey) {
        mClient = new com.ook.group.android.otkritkionline.bugreport.Client.Builder(application).buildWithApiKey(apiKey);
    }
    ...
    public static void initWithEmail(@NonNull Application application, @NonNull String email) {
        mClient = new com.ook.group.android.otkritkionline.bugreport.Client.Builder(application).buildWithEmail(email);
    }
     ...
     */
    public static void addAttachment(@NonNull com.ook.group.android.otkritkionline.bugreport.Attachment attachment) {
     ...
     */
    public static void setListener(@Nullable com.ook.group.android.otkritkionline.bugreport.BuglifeListener listener) {
    ...
    static void submitReport(com.ook.group.android.otkritkionline.bugreport.Report report, ReportSubmissionCallback callback) {
    ...
    private static com.ook.group.android.otkritkionline.bugreport.Client getClient() {
        if (mClient == null) {
