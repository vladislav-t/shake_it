...
import com.ook.group.android.otkritkionline.bugreport.reporting.BugReporter;
import com.ook.group.android.otkritkionline.bugreport.reporting.ClientEventReporter;
import com.ook.group.android.otkritkionline.bugreport.reporting.ReportSubmissionCallback;
import com.ook.group.android.otkritkionline.bugreport.screenrecorder.ScreenRecorder;
import com.ook.group.android.otkritkionline.bugreport.screenrecorder.ScreenRecordingPermissionHelper;
...
final class Client implements com.ook.group.android.otkritkionline.bugreport.ForegroundDetector.OnForegroundListener, InvocationMethodManager.OnInvocationMethodTriggeredListener {
    ...
    @Nullable private com.ook.group.android.otkritkionline.bugreport.BuglifeListener mListener;
    ...
    private final com.ook.group.android.otkritkionline.bugreport.ForegroundDetector mForegroundDetector;
    ...
    @NonNull private final com.ook.group.android.otkritkionline.bugreport.AttributeMap mAttributes;
    ...
    Client(Application application, BugReporter reporter, @NonNull final ApiIdentity apiIdentity) {
        try {
            ...
            com.ook.group.android.otkritkionline.bugreport.Log.d("Crashlife found, initialized");
        ...
        mAttributes = new com.ook.group.android.otkritkionline.bugreport.AttributeMap();
        mForegroundDetector = new com.ook.group.android.otkritkionline.bugreport.ForegroundDetector(application, this);
        mCollectLocationIfPossible = true;

        boolean hasPermissions = checkPermissions();

        if (!hasPermissions) {
            com.ook.group.android.otkritkionline.bugreport.Log.e("Android Manifest missing required permissions");
    ...
    void setListener(@Nullable com.ook.group.android.otkritkionline.bugreport.BuglifeListener listener) {
        mListener = listener;
    }
    ...
    @Deprecated
    void addAttachment(com.ook.group.android.otkritkionline.bugreport.Attachment attachment) {
    ...
    List<InputField> getInputFields() {
        ...
        if (inputFields == null || inputFields.isEmpty()) {
            com.ook.group.android.otkritkionline.bugreport.TextInputField summaryInputField = com.ook.group.android.otkritkionline.bugreport.TextInputField.summaryInputField();
    ...
    @Nullable FileAttachment captureScreenshot() {
        ...
        try {
            ...
            com.ook.group.android.otkritkionline.bugreport.Log.e("Error saving screenshot!", e);
    ...
    @Nullable FileAttachment makeCachedScreenshot(File systemScreenshotFile) {
        File file = generateScreenshotFile();
        try {
            com.ook.group.android.otkritkionline.bugreport.IOUtils.copy(systemScreenshotFile, file);
            return new FileAttachment(file, MimeTypes.PNG);
        } catch (IOException e) {
            com.ook.group.android.otkritkionline.bugreport.Log.e("Error copying screenshot!", e);
    ...
    void showReporter() {
        ...
        if (mReportFlowVisible) {
            com.ook.group.android.otkritkionline.bugreport.Log.e("Unable to show reporter; Buglife is already visible. Did you call showReporter() twice?");
            return;
        }
    ...
    void submitReport(com.ook.group.android.otkritkionline.bugreport.Report report, ReportSubmissionCallback callback) {
    ...
    static class Builder {
        ...
        Client buildWithApiKey(String apiKey) {
            return new Client(mApplication, new com.ook.group.android.otkritkionline.bugreport.BugReporterImpl(mApplication), new ApiIdentity.ApiKey(apiKey));
        }

        Client buildWithEmail(String email) {
            return new Client(mApplication, new com.ook.group.android.otkritkionline.bugreport.BugReporterImpl(mApplication), new ApiIdentity.EmailAddress(email));
        }
    }
    ...
    private boolean checkPermissions() {
        ...
        try {
            ...
            com.ook.group.android.otkritkionline.bugreport.Log.e("Unable to obtain package info", e);
            return false;
        }
    ...
    private @NonNull
    com.ook.group.android.otkritkionline.bugreport.BugContext buildBugContext() {
        com.ook.group.android.otkritkionline.bugreport.BugContext.Builder builder = new com.ook.group.android.otkritkionline.bugreport.BugContext.Builder(mAppContext)
    ...
    void showParameters() {
        Intent intent = com.ook.group.android.otkritkionline.bugreport.ParametersActivity.newStartIntent(mAppContext);
        mForegroundDetector.getCurrentActivity().startActivity(intent);
    }
}
