...
public class FileAttachment implements Parcelable {
    ...
    private byte[] toByteArray() throws IOException {
        ...
        try {
            com.ook.group.android.otkritkionline.bugreport.IOUtils.write(inputStream, outputStream);
            return outputStream.toByteArray();
        } finally {
            com.ook.group.android.otkritkionline.bugreport.IOUtils.closeQuietly(inputStream);
            com.ook.group.android.otkritkionline.bugreport.IOUtils.closeQuietly(outputStream);
        }
    }
