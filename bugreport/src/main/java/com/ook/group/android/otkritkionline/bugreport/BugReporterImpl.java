...
import com.ook.group.android.otkritkionline.bugreport.reporting.SubmitReportLegacyService;
import com.ook.group.android.otkritkionline.bugreport.reporting.SubmitReportService;
import com.ook.group.android.otkritkionline.bugreport.reporting.SubmitReportTask;
...
final class BugReporterImpl implements BugReporter {
    ...
    @Override public void report(Report report, ReportSubmissionCallback callback) {
        ...
        try {
            ...
            com.ook.group.android.otkritkionline.bugreport.Log.e("Failed to serialize bug report!", e);
            callback.onFailure(ReportSubmissionCallback.Error.SERIALIZATION, e);
            return;
        } catch (IOException e) {
            com.ook.group.android.otkritkionline.bugreport.Log.e("Failed to write bug report file!", e);
            callback.onFailure(ReportSubmissionCallback.Error.SERIALIZATION, e);
            return;
        }
        finally {
            ...
            try {
                File tempAttachmentDir = new File(mContext.getCacheDir() + com.ook.group.android.otkritkionline.bugreport.Attachment.TEMP_ATTACHMENTS_DIR);
                IOUtils.deleteRecursively(tempAttachmentDir);
            } catch (IOException e) {
                com.ook.group.android.otkritkionline.bugreport.Log.e("Failed to delete temporary attachment directory, temp attachments may be leaking", e);
        ...
        if (!forceLegacy && !shouldUseLegacyReporter()) {
            com.ook.group.android.otkritkionline.bugreport.Log.d("Attempting to schedule report submission...");

            JobScheduler jobScheduler = (JobScheduler) mContext.getSystemService(Context.JOB_SCHEDULER_SERVICE);

            if (jobScheduler != null) {
                com.ook.group.android.otkritkionline.bugreport.Log.d("Acquired JobScheduler service...");
                reportWithJobScheduler(reportFile, jobScheduler);
            } else {
                com.ook.group.android.otkritkionline.bugreport.Log.e("JobScheduler unavailable; Falling back to legacy report submission.");
                reportWithLegacy(reportFile);
            }
        } else {
            com.ook.group.android.otkritkionline.bugreport.Log.d("Submitting report using legacy service.");
            reportWithLegacy(reportFile);
        }
