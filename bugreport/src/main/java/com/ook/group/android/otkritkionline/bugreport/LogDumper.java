...
final class LogDumper {
    ...
    static void dumpToFile(File file) throws IOException {
        ...
        for (com.ook.group.android.otkritkionline.bugreport.LogMessage logMessage : getLogMessages()) {
            JSONObject json = logMessage.toJSON();
            jsonArray.put(json);
        }
        com.ook.group.android.otkritkionline.bugreport.IOUtils.writeStringToFile(jsonArray.toString(), file);
    }

    private static List<com.ook.group.android.otkritkionline.bugreport.LogMessage> getLogMessages() {
        ...
        ArrayList<com.ook.group.android.otkritkionline.bugreport.LogMessage> logMessages = new ArrayList<>();
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if (matcher.matches() && matcher.groupCount() > 4) {
                    ...
                    com.ook.group.android.otkritkionline.bugreport.LogMessage logMessage = new com.ook.group.android.otkritkionline.bugreport.LogMessage(timestamp, level, tag, message);
                    logMessages.add(logMessage);
                }
            }
        } catch (IOException ex) {
            com.ook.group.android.otkritkionline.bugreport.Log.e("Error dumping logs", ex);
        }
