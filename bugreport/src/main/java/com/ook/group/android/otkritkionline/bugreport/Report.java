...
public final class Report {
    ...
    public JSONObject toJSON() throws JSONException, IOException {
        ...
        com.ook.group.android.otkritkionline.bugreport.Attribute summaryAttribute = mBugContext.getAttribute(TextInputField.SUMMARY_ATTRIBUTE_NAME);
        ...
        if (location != null) {
            com.ook.group.android.otkritkionline.bugreport.Attribute deviceLocation = new com.ook.group.android.otkritkionline.bugreport.Attribute("" + location.getLatitude() + "," + location.getLongitude(), com.ook.group.android.otkritkionline.bugreport.Attribute.ValueType.STRING, com.ook.group.android.otkritkionline.bugreport.Attribute.FLAG_SYSTEM);
            attributes.put("Device location", deviceLocation);
        }

        for (Map.Entry<String, com.ook.group.android.otkritkionline.bugreport.Attribute> attribute : attributes.entrySet()) {
            String attributeName = attribute.getKey();
            com.ook.group.android.otkritkionline.bugreport.Attribute attr = attribute.getValue();
