...
public final class VideoActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        intent.setExtrasClassLoader(com.ook.group.android.otkritkionline.bugreport.FileAttachment.class.getClassLoader());
        com.ook.group.android.otkritkionline.bugreport.FileAttachment videoAttachment = intent.getParcelableExtra(INTENT_KEY_ATTACHMENT);
