...
final class TextInputFieldView extends com.ook.group.android.otkritkionline.bugreport.InputFieldView {
    ...
    private void init() {
        ...
        mColorPalette = new com.ook.group.android.otkritkionline.bugreport.ColorPalette.Builder(getContext()).build();
        setHintColor();
    }

    @Override
    public void configureWithInputField(@NonNull InputField inputField, @NonNull final ValueCoordinator valueCoordinator) {
        final com.ook.group.android.otkritkionline.bugreport.TextInputField textInputField = (com.ook.group.android.otkritkionline.bugreport.TextInputField)inputField;
